            ...
            <table className="table  table-sm small">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td className="text-left"><a target="_blank" rel="noopener noreferrer" href={`https://etherscan.io/address/${rtoken?.address}`}>{token?.address}</a></td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    const buyOrderOnSubmit = async (e: any ) => {
        ...
        return(
            ...
            <form className ="row" onSubmit={(event) => {
                ...
                registerToken( dados.pairs, dados.exchange, dados.account,dados.token.address )
